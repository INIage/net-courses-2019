namespace TradeSimulator.Core.Services
{
    ...
    public class TradingService
    {
        ...
        public void MakeATrade(TransactionInfo args)
        {
            ...
            {
                throw new ArgumentException("This TransactionInfo doesnt contain type of stock");
            };
            ...
            var stockOfSeller = stockOfClientTableRepository.GetStockOfClientEntityByClientIdAndType(sellerAccount.ClientId, args.TypeOfStock);
            if ((stockOfSeller == null) || (stockOfSeller.quantityOfStocks < args.QuantityOfStocks))
            {
            ...
            if (reminderStock == 0)
            {
                stockOfClientTableRepository.Remove(stockForTrade);
