namespace TradingSoftware.Core.Services
{
    ...
    public class TransactionManager : ITransactionManager
    {
        ...
        public IEnumerable<TransactionsFullData> GetAllTransactions()
        {
            var transactions = this.transactionRepository.GetAllTransaction();
            List<TransactionsFullData> transactionsFullData = new List<TransactionsFullData>();
            foreach (var transaction in transactions)
            {
                transactionsFullData.Add(
        ...
        {
            return transactionRepository.GetQueryableTransactions();
        }
